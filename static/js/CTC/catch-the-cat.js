! function(t) {
    ...
    var k = function(t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            set: function(t) {
                switch (t) {
                    case i.PLAYING:
                        break;
                    case i.LOSE:
                        this.setStatusText(f.default("The cat has been chased to the edge of the map, you lost!"));
                        break;
                    case i.WIN:
                        this.setStatusText(f.default("The cat has nowhere to go, you won!"));
                        break;
                    default:
                        return
                }
            ...
            if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("The Game is Over❗ Please restart the game. 😁")), this.reset(), !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("You are not allowed to click on wall location")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("Your are not allowed to click on the cat's location")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("You just caught a cat, you won!")), this.state = i.WIN, !1) : (this.setStatusText(f.default("You clicked on") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("Well, cat surrendered, you won")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("Code error, the location does not exist!")), !1)
        }, e.prototype.reset = function() {
            this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("Click on the circle spots, wrap the cat to win"))
    ...
    var i = n(0),
        s = function(t) {
            function e(e) {
                var n = this;
                e.credit || (e.credit = "俊樹"), e.backgroundColor || (e.backgroundColor = 15658734);
                var o = e.w,
                    r = e.h,
